...
namespace Microsoft.AspNetCore.Mvc
{
    public static class FlashHelpers
    {
        ...
        public static void FlashInfo(this Controller controller, ErrorViewModel errorViewModel)
        {
            AddMessageToTempData(controller, AlertType.Info, "", errorViewModel.ErrorMessage, _tempDataString);
        }
        public static void FlashInfo(this Controller controller, ErrorViewModel errorViewModel, string tmpData)
        {
            AddMessageToTempData(controller, AlertType.Info, "", errorViewModel.ErrorMessage, tmpData);
        }
        ...
        public static void FlashSuccess(this Controller controller, ErrorViewModel errorViewModel)
        {
            AddMessageToTempData(controller, AlertType.Success, "", errorViewModel.ErrorMessage, _tempDataString);
        }
        public static void FlashSuccess(this Controller controller, ErrorViewModel errorViewModel, string tmpData)
        {
            AddMessageToTempData(controller, AlertType.Success, "", errorViewModel.ErrorMessage, tmpData);
        }
        ...
        public static void FlashWarning(this Controller controller, ErrorViewModel errorViewModel)
        {
            AddMessageToTempData(controller, AlertType.Warning, "", errorViewModel.ErrorMessage, _tempDataString);
        }
        public static void FlashWarning(this Controller controller, ErrorViewModel errorViewModel, string tmpData)
        {
            AddMessageToTempData(controller, AlertType.Warning, "", errorViewModel.ErrorMessage, tmpData);
        }
        ...
        public static void FlashError(this Controller controller, ErrorViewModel errorViewModel)
        {
            AddMessageToTempData(controller, AlertType.Error, "", errorViewModel.ErrorMessage, _tempDataString);
        }
        public static void FlashError(this Controller controller, ErrorViewModel errorViewModel, string tmpData)
        {
            AddMessageToTempData(controller, AlertType.Error, "", errorViewModel.ErrorMessage, tmpData);
        }
